...
relative_position_and_velocity_PS               = import_SPICE_Earth_Position_And_Velocity___St___C (time_UTC);
...
%	The relevant results are all scalars output in arrays whose first dimensions correspond to the Star {phi_S, theta_S} and latter to the Planet {phi_P, theta_P}. 
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
