...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Close/clear all and start stopwatch for execution time                                                                                                  %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Close all, clear all, clear text in command window   
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Physical constants: gravitational constant (N⋅m^2/kg^2), speed of light (m/s)   
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Solar luminosity (W) and angular frequency of eart (rad/sec) [using an estimated 365.25 days/year, multiplied by 86400 seconds per day]  
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%


solar_luminosity = 3.846e26;
omega_Earth      = 2*pi/(365.25*86400);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Define time and a matrix that will contain ray times and coordinates                                                                                    %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Define UTC time (Universal Time Coordinated) [perihelion: '2025-01-01T12:00:00'] [aphelion: '2025-07-04T12:00:00']    
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Define the number of rays, and then a matrix of zeros with this many rows and 14 columns    
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Calculate sun + earth geometry                                                                                                                          %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	"cspice_str2et converts time to 'ephemeris time' (ET): a double precision value representing the number of TDB seconds past the J2000 epoch."
%
...
distance_Sun_Earth           = norm(Earth_pos);
Earth_velocity               = state(4:6)';


%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Normalize vectors representing sun and earth positions   
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Calculate the angle between the position of the sun and the earth's velocity (in radians), convert it to degrees.       
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%


Sun_pos_Earth_velocity_angle = rad2deg(func_angle_between_vectors(Sun_pos_normalized', Earth_velocity_normalized')); 
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Define the distance (km) from the sun to L_1 as this solution, and calculate the distance (km) from the earth to L_1, as well as a ratio of distances. 
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%


distance_Sun_L1   = double(S(1));
distance_Earth_L1 = (distance_Sun_Earth - distance_Sun_L1);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Calculate "Earth orientation at the defined time" and the effective solar constant                                                                      %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%	(https://naif.jpl.nasa.gov/pub/naif/toolkit_docs/IDL/icy/cspice_pxform.html)   
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Calculate 'solar constant': solar power per unit area impacting the earth.    
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Define sunshade architecture geometry and material properties                                                                                           %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	"Calculate rotational matrix for ray"                                                                                                                   %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Generate solar rays ("Ray tracing")                                                                                                                     %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Select methodology for generating solar rays    
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Display count of every 100 rays processed     
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%%%%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::%%%%
%%%%	Process rays according to selected methodology
%%%%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::%%%%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Randomize the ray's point of origin on the sun 
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Randomize the ray's point of contact at ("Sun-Earth") L1  
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%%%%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::%%%%
%%%%	End method-specific ray processing
%%%%::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::%%%%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Determine if the ray passes through the dust cloud   
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Determine if the ray hits the earth   
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Display percentrage of generated rays hitting earth, and the percentage hitting both the earth and the architecture                                     %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%	Convert ray point of impact on earth to spherical coordinates (latitude and longitude). Then stop program stop-watch.                                   %&%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	Create a matrix to store all spherical coordinates (latitude,longitude) of ray point of impact on earth
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
%	"cspice_reclat converts rectangular (Cartesian) coordinates to latitudinal coordinates. All coordinates are expressed as double precision values."
%
%	(https://naif.jpl.nasa.gov/pub/naif/toolkit_docs/MATLAB/mice/cspice_reclat.html)    
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
