...
%	the formulation below avoids errors. FIX TREATMENT OF SINGLE ELEMENT PARTITIONS OF THE PLANET.
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%


dimensions_SE                                     = [1:ndims(solar_irradiances_P)];
dimensions_E                                      = [dimensions_SE(1,end-1) dimensions_SE(1,end)];
dimensions_SE(dimensions_SE >= dimensions_E(1,1)) = [];
dimensions_S                                      = dimensions_SE;
...
solar_irradiances_P        = permute(solar_irradiances_P, [dimensions_E dimensions_S]);
