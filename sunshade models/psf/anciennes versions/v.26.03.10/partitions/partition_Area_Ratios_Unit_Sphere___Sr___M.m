function    [partition_area_ratios] = ...
			........................................................................................................................................................
            partition_Area_Ratios_Unit_Sphere___Sr___M (partition)
...
partition_phi_boundaries       = generate_1D_Subinterval_Boundaries___RS___R(partition.phi.interval, partition.phi.n);
...
theta_interval_ratio           = abs(partition.theta.interval(1,1) - partition.theta.interval(1,2)) / 360;
...
partition_area_ratios          = (1/2) * abs(sind(partition_phi_boundaries_upper) - sind(partition_phi_boundaries_lower)) * theta_interval_ratio / partition.theta.n;
