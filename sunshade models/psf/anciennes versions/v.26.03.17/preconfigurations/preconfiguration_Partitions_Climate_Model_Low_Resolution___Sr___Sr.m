...
%------------------------------------------------------------------------------------------------------------------------------------------------------------------%
		...
		model_parameters.planet.theta.interval = [-90 - half_step_longitude , 90 + half_step_longitude];

		model_parameters.planet.phi.n          = 288;
		model_parameters.planet.theta.n        = 192;
